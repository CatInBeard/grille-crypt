...
namespace grille{
	...
	namespace abstractFactory{
		...
		AbstractSystemDependedFactory* getConcreteFactory();

		AbstractSystemDependedFactory* AbstractSystemDependedFactory::instance {nullptr};
		AbstractSystemDependedFactory* AbstractSystemDependedFactory::getInstance(){
			if(!instance){
				instance = {getConcreteFactory()};
			}
			return instance;
		}
		AbstractSystemDependedFactory::~AbstractSystemDependedFactory(){
			delete instance;
		};
